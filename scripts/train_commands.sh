...
CUDA_VISIBLE_DEVICES=2,3 python src/supcl/main_supcon.py --batch_size 1536 --model resnet18 --dataset cifar100 --epochs 700 --print_freq 17 --warm --learning_rate 2 --cosine --method SigCLBaseAvgV2 --init_logit_bias -10 --neg_weight 3076 --bidir --linear_epochs 50 --num_workers=9 --logit_learning_rate 0.2 --log_wandb
